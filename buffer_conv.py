...
s.partition(WB)
s.partition(w_conv1, dim = 2)
s.partition(w_conv1, dim = 3)
#s[bnn_conv.conv1].pipeline(bnn_conv.conv1.axis[2])
s[bnn_conv.conv1_pad].pipeline(bnn_conv.conv1_pad.axis[2])
